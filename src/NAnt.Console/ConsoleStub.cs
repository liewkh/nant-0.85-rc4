    ...
    public class ConsoleStub {
        ...
        private static string FrameworkVersion {
            get {
                ...
                XmlNode nantNode = (XmlNode) System.Configuration.ConfigurationManager.GetSection("nant");
                if (nantNode == null) {
        ...
        public static int Main(string[] args) {
            ...
            string nantShadowCopyFilesSetting = System.Configuration.ConfigurationManager.AppSettings.Get("nant.shadowfiles");
            string nantCleanupShadowCopyFilesSetting = System.Configuration.ConfigurationManager.AppSettings.Get("nant.shadowfiles.cleanup");
